...
var addAndUpdateTables = function(){
  ...
  queryClient.connect();
  //add tables
  queryClient.query('CREATE TABLE IF NOT EXISTS auth(auth_id SERIAL PRIMARY KEY, heroku_app_id VARCHAR(40), github_token VARCHAR(40), slack_app_token VARCHAR(40), user_id VARCHAR(40), team_name VARCHAR(40), team_id VARCHAR(40), bot_id VARCHAR(40), bot_token VARCHAR(40))');
